...
async def test_door_opened(sut, safe_mode_state, ready_to_fire, fired, safe_mode_active, expected, monkeypatch, mocker):
  sut.state = State()
  ...
  monkeypatch.setattr(sut, "get_state", fake_func(to_return=safe_mode_state, is_async=True))
